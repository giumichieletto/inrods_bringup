...
def generate_launch_description():
    ...
    inrods_bringup_dir = get_package_share_directory('inrods_bringup')
    nav2_bringup_dir = get_package_share_directory('nav2_bringup')
    kobuki_dir = get_package_share_directory('kobuki_node')
    inrods_launch_dir = os.path.join(inrods_bringup_dir, 'launch')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join('/home/devlab03/lab_map.yaml'),
    ...
    urdf = os.path.join(kobuki_dir, 'urdf', 'kobuki_standalone.urdf')
    ...
    bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(inrods_bringup_dir, 'launch', 'bringup_kobuki.launch.py')),
